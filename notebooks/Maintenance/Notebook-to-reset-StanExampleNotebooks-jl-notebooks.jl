...
notebook_files = [
    ...
    "~/.julia/dev/StanExampleNotebooks/notebooks/CausalInference/The book of why/Example 10.jl",
...
notebooks_df.reset .= false;

# ╔═╡ 722d4847-2458-4b23-b6a0-d1c321710a2a
notebooks_df

# ╔═╡ 9d94bebb-fc41-482f-8759-cdf224ec71fb
reset_selected_notebooks_in_notebooks_df!(notebooks_df; display_actions=true, reset_activate=true, set_activate=false)
...
manifest_format = "2.0"
project_hash = "7ada646a464f2716d4c45b038ea9f7fe04ecb3f7"
