...
df = read_samples(sm, :dataframe)[:, 13:16]

# ╔═╡ df11a159-d82a-4c3a-93ee-a5a5a5e64fc4
n2 = names(df)

# ╔═╡ e6456796-0616-4911-a89f-294684596d70
gm = Dict{Symbol, Array}(:bar => Any[(8, [1]), (9, [2])], :bar2 => Any[(10, [1]), (11, [2, 1]), (12, [2, 2])], :bar3 => Any[(13, [1]), (14, [2, 1]), (15, [2, 2, 1]), (16, [2, 2, 2])], :x => Any[(2, [1, 1]), (3, [2, 1]), (4, [1, 2]), (5, [2, 2]), (6, [1, 3]), (7, [2, 3])]);
