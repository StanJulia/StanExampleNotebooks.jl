...
{" (found before start of program)",
 " (in '/Users/rob/.julia/dev/StanExampleNotebooks/notebooks/BridgeStan/bernoulli.stan', line 6, column 2 to column 30)",
 " (in '/Users/rob/.julia/dev/StanExampleNotebooks/notebooks/BridgeStan/bernoulli.stan', line 9, column 2 to column 20)",
 " (in '/Users/rob/.julia/dev/StanExampleNotebooks/notebooks/BridgeStan/bernoulli.stan', line 10, column 2 to column 23)",
 " (in '/Users/rob/.julia/dev/StanExampleNotebooks/notebooks/BridgeStan/bernoulli.stan', line 2, column 2 to column 17)",
 " (in '/Users/rob/.julia/dev/StanExampleNotebooks/notebooks/BridgeStan/bernoulli.stan', line 3, column 25 to column 26)",
 " (in '/Users/rob/.julia/dev/StanExampleNotebooks/notebooks/BridgeStan/bernoulli.stan', line 3, column 2 to column 28)"};
...
class bernoulli_model final : public model_base_crtp<bernoulli_model> {
 ...
 public:
  ...
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.31.0", "stancflags = --include-paths=. --warn-pedantic --O1"};
  }
